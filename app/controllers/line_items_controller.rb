class LineItemsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to store_url }
      format.js { @line_items = LineItem.select{ |line_item| line_item.cart_id == session[:cart_id]} }
    end
  end
  ...
  def increase
    ...
    respond_to do |format|
      if @line_item.save
        format.html { redirect_to store_url }
        format.js { @line_items = LineItem.select{ |item| item.cart_id == session[:cart_id]} }
      else
        format.json { render json: @line_item.errors, status: :unprocessable_entity }
      end
    end
